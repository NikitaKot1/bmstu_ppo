...
class IntegrationTest {
    ...
    fun createManufacturer() {
        ...
        assertDoesNotThrow { facade.createManufacturer(Manufacturer(11u, "log1", "pas1")) }
    }
}
...
class IngredientTest {
    ...
    fun createIngredient() {
        val expected = Ingredient(6u, "dark hop", IngredientType.HOP, 1u)
        facade.createIngredient(expected)
        val actual = facade.getIngredient(6u)
    ...
    fun createIngredientNotUniq() {
        val tmp = Ingredient(5u, "name1", IngredientType.YEAST, 1u)
